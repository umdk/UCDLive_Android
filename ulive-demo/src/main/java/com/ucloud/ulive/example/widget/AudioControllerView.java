...
public class AudioControllerView extends RelativeLayout implements View.OnClickListener, UStreamStateListener, UNetworkListener {
    ...
    class ViewHolder {
        ...
        private void registerListener() {
            //right pannel
            toggleRecordBtn.setOnClickListener(AudioControllerView.this);
            toggleMuteBtn.setOnClickListener(AudioControllerView.this);
            toggleMixBtn.setOnClickListener(AudioControllerView.this);
            exitBtn.setOnClickListener(AudioControllerView.this);

            //debug pannel
            copyToClipboardTxtv.setOnClickListener(AudioControllerView.this);
            clearDebugLogTxtv.setOnClickListener(AudioControllerView.this);
            toggleDebugLogVivisbleTxtv.setOnClickListener(AudioControllerView.this);
        }
    }
    ...
    public AudioControllerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setStreamer(UAudioStreaming streamer) {
...
//                mViewHolder.framerateTxtv.setText(String.format(Locale.US, "draw fps:%.2f, send fps:%.2f", streamer.getDrawFps(), streamer.getSendFps()));
    ...
    public void updateStreamEnvUI(AVOption option, UAudioStreaming streamer) {
        initBtnState(option);
